...
require_relative "./lib/rails/crud/version"

Gem::Specification.new do |spec|
  spec.name = "rails-crud"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/YamabikoLab/rails-crud"
  spec.metadata["changelog_uri"] = "https://github.com/YamabikoLab/rails-crud/blob/main/CHANGELOG.md"
  ...
  spec.add_runtime_dependency "rubyXL", '3.4.14'
